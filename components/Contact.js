        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            ...
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#333333] hover:border hover:border-gray-50 p-4">
                <svg
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-gray-50 p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a
                ...
                className="h-10 w-10 rounded-full hover:bg-red-900 flex items-center justify-center cursor-pointer"
              >
                <svg
                  width="24"
                  height="24"
